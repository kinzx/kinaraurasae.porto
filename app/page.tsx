...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      ...
      >
        <div className="absolute bottom-0 left-0 h-[112vw] max-h-[58rem] min-h-[34rem] w-[112vw] max-w-[58rem] min-w-[34rem] -translate-x-1/3 translate-y-1/4 rounded-full bg-[#f4f4f4] md:left-60" />
